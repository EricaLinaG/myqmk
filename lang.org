...
These keys are easiest to define in /defs/altlocal_keys.def/ , The most important thing is to know how the name is constructed so that they can be properly defined.
